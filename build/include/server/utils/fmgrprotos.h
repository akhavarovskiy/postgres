...
extern Datum yaml_in(PG_FUNCTION_ARGS);
extern Datum yaml_out(PG_FUNCTION_ARGS);
extern Datum yaml_recv(PG_FUNCTION_ARGS);
extern Datum yaml_send(PG_FUNCTION_ARGS);
