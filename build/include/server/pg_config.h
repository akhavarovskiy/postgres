...
#define CONFIGURE_ARGS " '--prefix=/home/aleksandr/wsu/CS580/postgres/build' '--enable-debug' 'CFLAGS=-O0'"
...
#define PG_VERSION_STR "PostgreSQL 16devel on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.2.0-19ubuntu1) 11.2.0, 64-bit"
